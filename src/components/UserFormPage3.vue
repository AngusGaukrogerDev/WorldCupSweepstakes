...
onMounted(() => {
        ...
        axios.get('http://195.201.227.74:3000/data') //change to correct_url:3000/data
        .then((response) => {
...
function assignTeam(teamList){
    ...
    if(x<32)
    {
        axios.post('http://195.201.227.74:3000//assigned', {"team": teamList[rand].team, "assignedUser": name.value})
...
function sendEmail() {
        ...
        axios.post('http://195.201.227.74:3000//sendemail', {"name": formData.name, "email": formData.email, "team": formData.team });
